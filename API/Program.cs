...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Patient_test", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Patient_testContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Patient_test API v1");
